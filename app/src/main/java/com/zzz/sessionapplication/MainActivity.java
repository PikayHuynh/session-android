...
public class MainActivity extends AppCompatActivity {
    ...
    private static final Map<Integer, Class<? extends AppCompatActivity>> ACTIVITY_PAGE = Map.of(
            1, ActivityBT1.class,
            2, ActivityBT2.class,
            3, ActivityBT3.class,
            4, ActivityBT4.class,
    ...
    private void init() {
        ...
        Glide.with(this)
                .load(R.drawable._8e31c2119edb0829c6e18d9b07eab49)
                .circleCrop()
                .into(imgLogo);
    ...
    private void act() {
        spinnerSelectExercise.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                String value = parent.getItemAtPosition(position).toString();
                int page = value.startsWith("Bài ")
